...
bosh int bosh-cpi-src/ci/bats-spec.yml \
  ...
  -v "network1-staticIP-2=192.168.111.193" \
  -v "network1-staticIP-1=192.168.111.194" \
  -v "network1-vCenterCIDR=192.168.111.192/26" \
  -v "network1-staticRange=[192.168.111.195-192.168.111.200]" \
  -v "network1-reservedRange=[192.168.1111.201-192.168.111.205]" \
  -v "network1-vCenterGateway=192.168.111.1" \
  -v "network1-vCenterVLAN=VM Network" \
  -v "network2-staticIP-1=192.168.111.225" \
  -v "network2-vCenterCIDR=192.168.111.224/26" \
  -v "network2-reservedRange=[192.168.111.226-192.168.111.231]" \
  -v "network2-staticRange=[192.168.111.232-192.168.111.237]" \
